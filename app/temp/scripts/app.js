...
document.querySelector('.book__btn').addEventListener('click', function () {
    ...
    var title = document.getElementById('book__title').value;
    var author = document.getElementById('book__author').value;
    var isbn = document.getElementById('book__isbn').value;
